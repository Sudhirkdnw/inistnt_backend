...
const syncSettings = async () => {
    try {
        const defaults = [
            ...
            { key: 'post_retention_days', value: 7, category: 'Retention', description: 'Auto-delete confessions and posts after X days (Set to 0 to keep forever / disable auto-delete)' },
            { key: 'chat_retention_hours', value: 24, category: 'Retention', description: 'Auto-delete chat messages & attachments after X hours (Set to 0 to keep forever / disable auto-delete)' },
            { key: 'notification_retention_days', value: 14, category: 'Retention', description: 'Auto-delete notifications after X days (Set to 0 to disable)' },
            ...
            { key: 'premium_photo_confessions_enabled', value: true, category: 'Features', description: 'Allow Premium users to attach and publish photos with their confessions.' },
            { key: 'premium_photo_blur_locked_enabled', value: true, category: 'Features', description: 'Lock and blur photo confessions for free users with a VIP paywall prompt on the home feed.' },
            { key: 'explore_photos_enabled', value: true, category: 'Features', description: 'Enable or disable the Explore Photos Grid section on the mobile app Explore tab.' },
            { key: 'explore_photos_visibility', value: 'all', category: 'Features', description: 'Audience access for Explore Photos: "all" (All Users) or "vip_only" (VIP/Premium Users Only).' },
            { key: 'explore_photos_show_profile_photos', value: true, category: 'Features', description: 'Include public student profile gallery photos in Explore Photos Grid.' },
            { key: 'explore_photos_show_confession_photos', value: true, category: 'Features', description: 'Include confession photos in Explore Photos Grid.' },
